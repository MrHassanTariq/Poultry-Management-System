...
namespace PoultaryManagementSystem.Controllers
{
    public class WorkersController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "WorkerID,Name,PhoneNumber")] Worker worker)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "WorkerID,Name,PhoneNumber")] Worker worker)
        {
            if (ModelState.IsValid)
            {
